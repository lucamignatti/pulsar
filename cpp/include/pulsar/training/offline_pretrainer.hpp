...
class OfflinePretrainer {
 public:
  ...
  void train(const std::string& output_dir);
 ...
 private:
  ...
  NextGoalPredictor next_goal_model_{nullptr};
  ObservationNormalizer normalizer_;
  torch::optim::AdamW policy_optimizer_;
  torch::optim::AdamW next_goal_optimizer_;
